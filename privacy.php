                    ...
                    <div class="card shadow-sm">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <section class="mb-4">
                                ...
                                <ul>
                                    <li><strong>Personal Information:</strong> Name, email address, phone number, and other identifiers you provide when registering or using our Services.</li>
                                    <li><strong>Usage Data:</strong> Information about how you use our Services, including browsing history and interaction with features.</li>
                                    <li><strong>Content:</strong> Videos and other content you upload to our Services for processing.</li>
                            ...
                            <section class="mb-4">
                                ...
                                <ul>
                                    ...
                                    <li>Processing your video content according to your instructions</li>
                                    <li>Communicating with you about our Services</li>
                                    <li>Personalizing your experience</li>
                                    <li>Analyzing usage patterns to improve functionality</li>
                                    <li>Protecting against unauthorized access and ensuring security</li>
                                </ul>
                            </section>
                            ...
                            <section>
                                ...
                                <p>privacy@videoprocessor.com</p>
                            </section>
                        </div>
                    </div>
                </div>
